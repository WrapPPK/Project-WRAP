...
<div class="container-fluid">
    <div class="row">
        ...
        <div class="col-md-6 order-md-1" style="padding-top: 90px; padding-right: 100px; padding-left: 100px;">
            <form action="/authDoctor" method="POST">
                @csrf
                ...
                <div class="mb-3">
                    ...
                    <input type="text" name="email" id="emailDokter" class="form-control w-100" placeholder="Enter Email" style="border-color: rgba(34, 101, 151, 1); border-width: 3px;">
                </div>
                <div class="mb-3">
