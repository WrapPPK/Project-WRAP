                ...
                <form action="/register" method="POST" class="form-valid" enctype="multipart/form-data">
                    ...
                    @if ($errors->any())
                        ...
                        <div class="col">
                            <div class="row">
                                <div class="col-md-6 mb-3">
                                    <label for="name" class="form-label"
                                        style="color: rgba(34, 101, 151, 1); font-weight: 700;">Full Name</label>
                                    <input type="text" id="name" name="name" class="form-control w-100"
                                        placeholder="Enter your name"
                                        style="border-color: rgba(34, 101, 151, 1); border-width: 3px;">
                                </div>
                                <div class="col-md-6 mb-3">
                                    <label for="email" class="form-label"
                                        style="color: rgba(34, 101, 151, 1); font-weight: 700;">Email</label>
                                ...
                                <div class="col-md-6 mb-3">
                                    <label for="birthdate" class="form-label"
                                        style="color: rgba(34, 101, 151, 1); font-weight: 700;">Date</label>
                                    <input type="date" id="birthdate" name="birthdate" class="form-control w-100">
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-md-6 mb-3">
                                    <label for="password" class="form-label"
                                        style="color: rgba(34, 101, 151, 1); font-weight: 700;">Password</label>
                                ...
                                <div class="col-md-6 mb-3">
                                    <label for="confirm_password" class="form-label"
                                        style="color: rgba(34, 101, 151, 1); font-weight: 700;">Confirm Password</label>
                                    <input type="password" id="confirm_password" name="password_confirmation"
                                        class="form-control w-100" placeholder="Enter your password"
                                        style="border-color: rgba(34, 101, 151, 1); border-width: 3px;">
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-md-6 mb-3">
                                    <label for="phone_number" class="form-label"
                                        style="color: rgba(34, 101, 151, 1); font-weight: 700;">Phone Number</label>
                                ...
                                <div class="col-md-6 mb-3">
                                    <label for="gender" class="form-label"
                                        style="color: rgba(34, 101, 151, 1); font-weight: 700;">Gender</label>
                            ...
                            <div class="mb-3">
                                <label for="doctor" class="form-label"
                                    style="color: rgba(34, 101, 151, 1); font-weight: 700;">Doctor</label>
                                <select id="doctor" name="doctor" class="form-control w-100"
                                    style="border: 2px solid rgba(34, 101, 151, 1); border-width: 3px;">
                        ...
                        <div class="mb-3 text-center">
                            <button type="submit" class="btn btn-primary" onclick="konfirmasiRegis()"
                                style="width: 100%; max-width: 570px; height: 50px; background-color:rgba(17, 63, 103, 1); font-weight:bold;">
                                Sign Up
                            </button>
                        </div>
                        <div class="Signup text-center">
                            <p>Already have an account? <a href="/login"
                                    style="text-decoration:none; font-weight:bold;">Sign in</a></p>
                        </div>
                </form>
            </div>
        </div>
