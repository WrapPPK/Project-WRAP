...
<div class="container-fluid">
    <div class="row">
        ...
        <div class="col-md-6 order-md-1" style="padding-top: 90px; padding-right: 100px; padding-left: 100px;">
            <form method="post" action="<?php echo e(route('dashDok')); ?>">
                <?php echo csrf_field(); ?>
...
<?php /**PATH C:\xampp\htdocs\Merge FE dan BE Wrap\Project-WRAP-david-new\resources\views/auth/loginDokter.blade.php ENDPATH**/ ?>