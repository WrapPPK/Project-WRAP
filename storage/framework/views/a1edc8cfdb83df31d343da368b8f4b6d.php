                ...
                <div class="row">
                    <div class="col-3" style="padding-top:20px;">
                        <div class="Profile" style="margin-bottom:10px; text-align: center;">
                            <img src="<?php echo e(asset('images/Dokter3.jpg')); ?>" alt="Doctor Image" class="img-fluid">
                        </div>
                    </div>
                        ...
                        <form action="#" method="POST" class="form-valid" enctype="multipart/form-data">
                            <div class="row pt-2">
                                <div class="col-md">
                                    ...
                                    <input type="text" value="<?php echo e($doctor->name); ?>" name="nameDokter" id="nameDokter" class="form-control" style="border-color: rgba(34, 101, 151, 1); border-width: 3px;">
                                </div>
                            </div>
                            <div class="row pt-2">
                                <div class="col-md">
                                    <label for="emailDokter" class="form-label" style="color: rgba(34, 101, 151, 1); font-weight: 700;">Email</label>
                                    <input type="text" value="<?php echo e($doctor->email); ?>" name="emailDokter" id="emailDokter" class="form-control" style="border-color: rgba(34, 101, 151, 1); border-width: 3px;">
                                </div>
                            </div>
                            <div class="row pt-2">
                                <div class="col-md">
                                    <label for="nikDokter" class="form-label" style="color: rgba(34, 101, 151, 1); font-weight: 700;">Nip</label>
                                    <input type="text" value="<?php echo e($doctor->nip); ?>" name="nikDokter" id="nikDokter" class="form-control" style="border-color: rgba(34, 101, 151, 1); border-width: 3px;" required>
                                </div>
                            </div>
                        </form>
                    </div>
...
<?php /**PATH C:\xampp\htdocs\Merge FE dan BE Wrap\Project-WRAP-david-new\resources\views/dokter/profileDokter.blade.php ENDPATH**/ ?>