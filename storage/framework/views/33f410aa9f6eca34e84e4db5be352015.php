...
<body style="background-color: rgba(243, 249, 251, 1);">
    ...
    <div class="gambarTulisan" style="position: relative; ">
        ...
        <div class="Kotak p-5" style="position: absolute; top: 25%; width: 45%; height: 60%; left: 7%;" data-aos="fade-up"data-aos-duration="3000">
    ...
    <div class="container-fluid" style="padding-bottom:100px">
        <div class="row text-center justify-content-center" style="padding-top:100px;padding-bottom:50px"  data-aos="fade-down" data-aos-duration="1000">
        ...
        <div class="row row-cols-3-cols-md-3 g-4" style="padding-left:100px;padding-right:100px;" data-aos="fade-down" data-aos-duration="500">
            <!-- card 1 -->
            <div class="col">
                <div class="card shadow" style="width: 400px; height: 400px;">
                    <div class="card-body d-flex flex-column justify-content-center">
                        ...
                        <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Proin eget elit sit amet arcu volutpat tincidunt. Mauris sollicitudin metus non magna pulvinar, nec pulvinar ex aliquet. Integer id convallis metus. Proin vel justo nec velit blandit vehicula</p>
                    </div>
                </div>
            </div>
            <!-- card 2 -->
    ...
    <div class="Aboutus">
        <div class="kotakputih">
            <div class="container-fluid" style="padding-bottom:100px">
                <div class="row text-center justify-content-center" style="padding-top:100px" data-aos="fade-down" data-aos-duration="1000">
                    <div class="col" style="padding-bottom:30px; font-size: 60px; font-weight:bold; color: rgba(34, 101, 151, 1)">
                        Our Teams
                    </div>
                    <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Nulla convallis arcu ac fermentum placerat.</p>
                </div>
                <div class="row row-cols-4-cols-md-3 g-4" style="padding-left:100px;padding-right:100px;" data-aos="fade-down" data-aos-duration="500">
                    <div class="col">
                        <div class="text-container p-5 text-align-center">
                            <div class="bulat p-5"></div>
...
<?php /**PATH C:\xampp\htdocs\Merge FE dan BE Wrap\Project-WRAP-david-new\resources\views/noLogin/body.blade.php ENDPATH**/ ?>