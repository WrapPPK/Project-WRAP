...
<body>
    ...
    <div class="container" style="margin-top:80px; text-align:center;">
        ...
        <div class="input-group mb-4 mx-auto" style="max-width: 568px">
            <input type="text" class="form-control" placeholder="Email" aria-label="Email" name="Email" value="<?php echo e($data->email); ?>" aria-describedby="basic-addon1" />
        </div>
        <div class="input-group mb-4 mx-auto" style="max-width: 568px">
            <input type="password" class="form-control" placeholder="Password" aria-label="Password" name="Password" value="<?php echo e($data->password); ?>"  aria-describedby="basic-addon1" />
        </div>
...
<?php /**PATH C:\xampp\htdocs\Merge FE dan BE Wrap\Project-WRAP-david-new\resources\views/admin/editAdmin.blade.php ENDPATH**/ ?>