...
<nav class="navbar navbar-expand-lg bg-body-tertiary shadow-lg">
        <div class="container-fluid">
            <a class="navbar-brand" href="<?php echo e(route('dashboardPasien')); ?>" style="margin-left:75px;">RespiraCare</a>
        ...
        <aside id="sidebar">
            <div class="d-flex">
                ...
                <div class="sidebar-logo">
                    <a href="<?php echo e(route('dashboardPasien')); ?>">
                        RespiraCare
                    </a>
                </div>
            </div>
...
<?php /**PATH C:\Users\HP\Documents\Semester 6\Konfigurasi\Project-WRAP\resources\views/Pasien/sidebar&navbar.blade.php ENDPATH**/ ?>