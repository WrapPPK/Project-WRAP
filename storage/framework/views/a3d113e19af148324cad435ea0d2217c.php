    ...
    <div class="container-fluid" style="margin-top: 100px; margin-bottom: 150px">
        <div class="container mx-auto">
            <div class="card border-0 shadow border-radius">
                ...
                <div class="card-body">
                    <form action="<?php echo e(route('pasiens.update', ['id' => $pasien->id])); ?>" method="POST"
                        ...
                        <div class="row pt-5">
                            ...
                            <div class="col-md-4">
                                ...
                                <input type="text" value="<?php echo e($pasien->nama_obat); ?>" name="nama_obat" id="nama_obat" class="form-control" required>
                            </div>
                        </div>
                        <div class="row pt-5">
                            <div class="col-md-4">
                        ...
                        <div class="row pt-5">
                            ...
                            <div class="col-md-4">
                                ...
                                <select name="status" id="inputObatSehari" class="form-control"
                                    style="border: 2px solid rgba(34, 101, 151, 1); border-width: 3px;"
                                    onchange="showHideTimeInput()">
                        ...
                        <div class="row pt-5">
                            ...
                            <div class="col-md-4">
                                ...
                                <input type="date" value="<?php echo e($pasien->mulai_minum); ?>" id="mulai_minum" name="mulai_minum">
                            </div>
                            <div class="col-md-4">
                                <label for="akhir_minum">Tanggal Akhir:</label>
                                <input type="date" value="<?php echo e($pasien->akhir_minum); ?>" id="akhir_minum" name="akhir_minum">
                            </div>
                        </div>
                        <div class="row pt-5">
                            <div class="col-md-4">
                                <label for="foto_profil" class="form-label">Foto Profil :</label>
                                <input value="<?php echo e($pasien->photo); ?>" type="file" name="photo" id="foto_profil" class="form-control" >
                            </div>
                        </div>
                        <div class="row pt-5">
                            <div class="col-md-12">
                                <div class="d-grid gap-2">
                                    <button type="submit" class="btn btn-md text-light" onclick="#"style="background-color: rgba(88, 95, 233, 1)">
                                        Submit
                                    </button>
                                </div>
                            </div>
...
<?php /**PATH C:\Users\HP\Documents\Semester 6\Konfigurasi\Project-WRAP\resources\views/dokter/updatePasien.blade.php ENDPATH**/ ?>