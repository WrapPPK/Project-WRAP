...
<body>
            ...
            <nav id="sidebar">
                <div class="position-sticky">
                    <ul class="nav flex-column mt-5">
                        <center>
                            <a class="navbar-brand me-auto" href="<?php echo e(route('dashboardAdmin')); ?>">
                                <img src=<?php echo e(url("images/RespiraCareLogo.png")); ?> alt="RespiraCare Logo" style="height: 180px; width: 180px;">
                            </a>
                        </center>
    ...
    <div class="container" style="margin-top:80px; text-align:center;">
        <form method="POST" action="<?php echo e(route('doctor.update', $data->id)); ?>" enctype="multipart/form-data" role="form">
        <?php echo csrf_field(); ?>
        ...
        <div class="input-group mb-2 mx-auto" style="max-width: 568px">
            <input type="text" class="form-control" placeholder="NIP" aria-label="NIP" value="<?php echo e($data->nip); ?>" name="NIP" aria-describedby="basic-addon1" />
        </div>
        <div class="input-group mb-1 mx-auto" style="max-width: 568px">Nama</div>
        <div class="input-group mb-2 mx-auto" style="max-width: 568px">
            <input type="text" class="form-control" placeholder="Name" aria-label="Name" value="<?php echo e($data->name); ?>" name="Name" aria-describedby="basic-addon1" />
        </div>
        <div class="input-group mb-1 mx-auto" style="max-width: 568px">Email</div>
        <div class="input-group mb-2 mx-auto" style="max-width: 568px">
            <input type="text" class="form-control" placeholder="Email" aria-label="Email" name="Email" value="<?php echo e($data->email); ?>" aria-describedby="basic-addon1" readonly/>
        </div>
...
<?php /**PATH C:\Users\HP\Documents\Semester 6\Konfigurasi\Project-WRAP\resources\views/admin/editAdmin.blade.php ENDPATH**/ ?>