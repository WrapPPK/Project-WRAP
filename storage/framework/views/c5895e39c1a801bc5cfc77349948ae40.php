                    ...
                    <form action="#" method="POST" class="form-valid" enctype="multipart/form-data">
                        ...
                        <div class="row pt-5">
                            ...
                            <div class="col-md-4">
                                ...
                                <input type="text" readonly value="<?php echo e($pasien->nama_obat); ?>" name="nama_obat" id="nama_obat" class="form-control" required>
                            </div>
                        </div>
                        <div class="row pt-5">
                            <div class="col-md-4">
                        ...
                        <div class="row pt-5 pb-5">
                            <h5 style="color:red;">Note: Jangka waktu minum obat <?php echo e($pasien->mulai_minum); ?> hingga <?php echo e($pasien->akhir_minum); ?></h5>
                        </div>
                    </form>
                </div>
            </div>
...
<?php /**PATH C:\Users\HP\Documents\Semester 6\Konfigurasi\Project-WRAP\resources\views/Pasien/pengingatPasien.blade.php ENDPATH**/ ?>